...
from kawaiitb.kraceback import _ENV  # noqa
...
def test_parse_module_filename_win():
    ...
    env = _ENV(
        ...
        site_packages={
            PureWindowsPath('C:/Users/usr/Desktop/project/.venv'),
...
def test_parse_module_filename_linux():
    ...
    env = _ENV(
        ...
        stdlib_paths={
            ...
            PurePosixPath('/usr/lib/python3'),
            PurePosixPath('/usr/lib/python3.12'),
            PurePosixPath('/home/user/project/venv/lib'),
        ...
        site_packages={
            ...
            PurePosixPath('/home/user/project/venv/local/lib/python3.12/dist-packages'),
            PurePosixPath('/home/user/project/venv/lib/python3/dist-packages'),
            PurePosixPath('/home/user/project/venv/lib/python3.12/site-packages'),
            PurePosixPath('/home/user/project/venv/lib/python3.12/dist-packages'),
        })
...
def test_parse_module_filename_qpy():
    test_cases = [
        ...
        # ("/storage/emulated/0/_qpy/project/main.py", ".", "project/main.py"),
    ]

    env = _ENV(
        cwd=PurePosixPath('/storage/emulated/0/_qpy'),
        platform='posix',
        stdlib_paths={
            PurePosixPath('/data/user/0/org.qpython.qpy/files/lib/python3.12'),
            PurePosixPath('/data/user/0/org.qpython.qpy/files/lib')
        },
        site_packages={
